...
describe('Given the create group modal is mounted', () => {
  ...
  it('should change group name when a user inputs the name of the group to be created', () => {
    enzymeWrapper.find('#name').simulate('change', { target: { id: 'name', value: 'mma freaks' } });
